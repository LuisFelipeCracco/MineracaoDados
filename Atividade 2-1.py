...
def main():
    ...
    output_file1 = 'hcvdatclearzscore.csv'
    output_file2 = 'hcvdatclearmin-max.csv'
    ...
    normalized1Df.to_csv(output_file1, header=False, index=False) #salva arquivo
    normalized2Df.to_csv(output_file2, header=False, index=False) #salva arquivo
