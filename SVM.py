...
def main():
    ...
    print("Acurácia do SVM usando Cross Validation, k = 10: ")
    print(scores)
    print("Média dos Scores do Cross Validation: ")
    print(scores.mean())
    ...
    plot_confusion_matrix(cm, ['Blood Donor','Hepatits'], False, "Confusion Matrix - SVM sklearn")      
    plot_confusion_matrix(cm, ['Blood Donor','Hepatits'], True, "Confusion Matrix - SVM sklearn normalized" )  
    plt.show()
